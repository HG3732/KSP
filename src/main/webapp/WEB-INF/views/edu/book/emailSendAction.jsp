...
<%
	// 사용자 인증 이메일 발송 내용
	String host = session.getServletContext().getContextPath() + "/WEB-INF/views/edu/book";
	String from = "seojw0730@gmail.com";
	String to = (String)session.getAttribute("book-email");
	String subject = "KSP 교육 신청 인증 메일"; 
