                ...
                <div class="edu-detail">
					<form id="frm-edudetail">
	                    <div class="edu-detail-content">
	                		<input type="hidden" name="eduId" value="${eduOne.eduId }" >
	                        <div class="grid eduOne">
	                            <div class="grid item1">
	                                <div class="grid item2">
	                                	...
	                                	<div class="grid item3">
	                                    	<input type="text" name="eduSubject" value="${eduOne.eduSubject }" required autocomplete="off">
	                                	</div>
	                                </div>
	                            ...
	                            <div class="grid item1">
	                                <input type="text" name="eduBookStart" value="${eduOne.eduBookStart }" class="datePicker" required autocomplete="off">
	                            </div>
	                            <div class="grid item1">
	                                ~
	                            </div>
	                            <div class="grid item1">
	                                <input type="text" name="eduBookEnd" value="${eduOne.eduBookEnd }" class="datePicker" required autocomplete="off">
	                            </div>
	                            <div class="grid item1">
	                                운영기간
	                            </div>
	                            <div class="grid item1">
	                                <input type="text" name="eduStart" value="${eduOne.eduStart }" class="datePicker" required autocomplete="off">
	                            </div>
	                            <div class="grid item1">
	                                ~
	                            </div>
	                            <div class="grid item1">
	                                <input type="text" name="eduEnd" value="${eduOne.eduEnd }" class="datePicker" required autocomplete="off">
	                            </div>
	                            <div class="grid item1">
	                                운영요일
	                            </div>
	                            ...
	                            <div class="grid item1">
	                                <input type="text" name="eduAddress" value="${eduOne.eduAddress }" required autocomplete="off">
	                            </div>
	                            <div class="grid item1">
	                                교육대상
	                            </div>
